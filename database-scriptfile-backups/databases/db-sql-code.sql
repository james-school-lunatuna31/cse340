...
-- Make sure that when you re-create the DB, the username below is updated
...
ADD CONSTRAINT fk_classiciation FOREIGN KEY (classification_id) REFERENCES public.classification (classification_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION;
-- Table structure for table 'account'
CREATE TABLE IF NOT EXISTS public.account (
    account_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    account_firstname character NOT NULL,
    account_lastname character NOT NULL,
    account_email character NOT NULL,
    account_password character NOT NULL,
...
-- SIXTH QUERY FROM ASSIGNEMNT TWO
